...
<div class="card border-0">
        <div class="card-body">
            ...
            <div class="card mt-4">
                <div class="card-header">Create a Convention</div>
                <div class="card-body">


                    <form method="POST" action="{{ action('Calendar\ConventionController@store') }}">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input id="tagline" type="text" 
                                        ...
                                        name="tagline" value="{{ old('tagline') }}" required > 
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 m-1">
                                            ...
                                            <input type="date" name='start_date' value="{{Carbon::now()->format('Y-m-d')}}"
                                        ...
                                        <div class="col-md-5 m-1">
                                            ...
                                            <input type="date" name='end_date' value="{{Carbon::tomorrow()->format('Y-m-d')}}"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea class="form-control{{ $errors->has('lead') ? ' is-invalid' : '' }}"
                                        name="lead" id="lead" cols="30" rows="2" >{{ old('lead') }}
                                    </textarea>
                                    @if ($errors->has('lead'))
                                        <span class="invalid-feedback">
